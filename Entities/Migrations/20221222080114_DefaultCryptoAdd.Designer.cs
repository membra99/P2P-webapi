...
namespace Entities.Migrations
{
    ...
    [Migration("20221222080114_DefaultCryptoAdd")]
    partial class DefaultCryptoAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.P2P.MainData.Author", b =>
                {
            ...
            modelBuilder.Entity("Entities.P2P.MainData.Crypto", b =>
                {
            ...
            modelBuilder.Entity("Entities.P2P.MainData.Page", b =>
                {
                    ...
                    b.Property<int?>("InvestmentPeriodInMonths")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.P2P.MainData.UrlLanguages", b =>
                {
                    b.Property<int>("UrlLanguagesID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("UrlLanguagesID");

                    b.HasIndex("DataTypeId");

                    b.HasIndex("LanguageId");

                    b.ToTable("UrlLanguages", "P2P");
                });
            ...
            modelBuilder.Entity("Entities.P2P.MainData.Blog", b =>
                {
                    b.HasOne("Entities.P2P.MainData.Author", "Author")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("Entities.P2P.MainData.Page", b =>
                {
                    ...
                    b.HasOne("Entities.P2P.MainData.Crypto", "Crypto")
                        .WithMany("Pages")
                        .HasForeignKey("DefaultCrypto")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Entities.P2P.MainData.Settings.SettingsAttribute", b =>
                {
                    ...
                    b.HasOne("Entities.P2P.MainData.UrlTable", "Url")
                        .WithMany("SettingsAttributes")
                        .HasForeignKey("UrlTableId")
                        .OnDelete(DeleteBehavior.Restrict);
